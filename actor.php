<?php
include ('sidenav.php'); //navigation bar
include ('connection.php'); //connect sql
include ('userAccess.php'); //check if login as user
...
if (isset($_GET['actor_id'])){
    ...
    //select movie image & details and link it with "actor" table through "actor_movie" table where it is = to actor_id
