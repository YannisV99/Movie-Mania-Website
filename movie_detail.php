    ...
    if(isset($_POST['addWatchlistBtn'])){
        ...
        if ($validateQuery && mysqli_num_rows($validateResult)>0){
            echo"<script>
                    ...
                    window.location='movie_detail.php?movie_id=" . $movie['movie_id'] . "';
                </script>";
        }else{
    ...
    <div id="main"> 
        <div class="details">
            <div class="detail1">
                ...
                <br>
                <a href="movies.php"><input type="button" value="Back" class="detailBtn"></a>
            </div>
            <div class="detail2">
        ...
        <div class="detail3">
            ...
            <a href="review.php?movie_id=<?php echo $movie['movie_id']?>"><input type="button" value="Write A Review" class="submitBtn"></a>
            <div class="reviews">
                <?php
