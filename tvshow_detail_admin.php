    ...
    if(isset($_POST['addWatchlistBtn'])){
        ...
        if($result){
            echo"<script>
                ...
                window.location='tvshow_detail_admin.php?tvshow_id=" . $movie['tvshow_id'] . "';
            </script>";
        }else{
            echo"<script>
    ...
    <div id="main"> 
        <div class="details">
            <div class="detail1">
                ...
                <br>
                <a href="update_tvshow.php?tvshow_id=<?php echo $movie['tvshow_id']?>"><input type="button" value="Update" class="detailBtn"></a>
                <br>
        ...
        <div class="detail3">
            ...
            <!-- <a href="review_admin.php?tvshow_id=<?php echo $movie['tvshow_id']?>"><input type="button" value="Write A Review" class="submitBtn"></a> -->
            <div class="reviews">
                <?php
